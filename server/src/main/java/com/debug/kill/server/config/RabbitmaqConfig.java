 ...
 *FileName:  RabbitmaqConfig
 * Author:   lvchengming
 * Description: TODO
 * Date  :   2020/2/18 13:00
 * Version: 1.0
 * */
...
public class RabbitmaqConfig {
    ...
    private final static Logger log= LoggerFactory.getLogger(RabbitmaqConfig.class);
    ...
    public SimpleRabbitListenerContainerFactory listenneerContainer(){
    ...
    public Binding successKillDeadBinding(){
        return BindingBuilder.bind(successKillDeadQueue()).to(successKillDeadProdExchange()).with(env.getProperty("mq.kill.item.success.kill.dead.routing.key"));
    }
}
